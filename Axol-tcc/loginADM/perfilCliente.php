...
<body id="top">
  ...
  <div class="texto-index">
    <h3>Pesquise e encontre o Cliente!</h3>
      ...
      <div class="main">
        ...
        <div class="search-box">
          <div class="searchbar">
            ...
            <input name="nome_usuario" id="keyword" type="text" placeholder="Use palavras-chave...">
          </div>
  ...
  <section class="section course" id="courses" aria-label="course" style="background-image: url('./assets/images/course-bg.jpg')">
    <div class="container">
      ...
      <h1>
        <p class="section-subtitle">Clientes Cadastrados!</p>
      </h1>
      ...
      <ul class="grid-list">
        ...
        try {
         ...
         if (is_array($dados)) {
          ...
          $stmt = $pdo->prepare("SELECT nomeUsuario, dataNascUsuario, sexoUsuario, cpfUsuario, emailUsuario, imagemUsuario, logradouroUsuario, complementoUsuario, 
          cepUsuario, bairroUsuario, cidadeUsuario, uf FROM tbusuario  
                    INNER JOIN tbtelefoneusuario ON tbtelefoneusuario.codUsuario = tbusuario.codUsuario
                    WHERE nomeUsuario LIKE :nome ORDER BY nomeUsuario ASC");
          ...
          while ($row = $stmt->fetch(PDO::FETCH_BOTH)) { ?>
            ...
            <li>
              <div class="course-card">
                ...
                <figure class="card-banner">
                  <img <?php echo "src='../restrito/imagens/" . $row['imagemUsuario'] . "'"; ?> width="370" height="270" loading="lazy" alt="Competitive Strategy law for all students" class="img-cover">
                
                </figure>
                <div class="card-actions">

              <span class="badge"><?php echo "" . $row['emailUsuario'] . ""; ?></span>
            ...
            <div class="card-content">
                  ...
                  <h3 class="h3">
                    <a href="#" class="card-title" name="nomePrestadorServico"><?php echo $row['nomeUsuario'] . "<br>"; ?></a>
                  </h3>
                  ...
                  <div class="card-footer">
                    <div class=""> <?php echo "Nascimento: " . $row['dataNascUsuario'] . "<br>"; ?></div>
                    <div class=""> <?php echo "Gênero: " . $row['sexoUsuario'] . "<br>"; ?></div>
                    <div class=""> <?php echo "CPF: " . $row['cpfUsuario'] . "<br>"; ?></div>
                    <div class=""> <?php echo "Email: " . $row['emailUsuario'] . "<br>"; ?></div>
                    ...
                    <div class=""> <?php echo "UF: " . $row['uf'] . "<br>"; ?></div>
