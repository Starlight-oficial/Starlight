...
<head>
    ...
    <link name="stylesheet" rel="stylesheet" href="../css/log2.css">
    ...
    <div class="container2">
        <div class="content2">
            ...
            <form name='login' method='post' action="valida-acesso.php">
                ...
                <div class="input-box">
                    <input type="text" name='txtLoginUser' id='txtLoginUser' required>
                    <label>Login</label>
                </div>
                <div class="input-box">
                    <input type='password' name='txtSenhaUser' id='txtSenhaUser' required>
                    <label>Senha</label>
                </div>
