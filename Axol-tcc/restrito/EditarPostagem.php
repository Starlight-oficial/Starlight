...
include_once('../restrito/decisao-editarPostagem.php');
global $conexao;
...
$imgPostagem = $_FILE['imgEditar']; //Vem do arquivo decisao-editarPostagem
...
$stmt = $conexao -> prepare ("update tbPostagem inner join tbPrestadorServico on tbPostagem.codPrestadorServico = tbPrestadorServico.codPrestadorServico
                             set descricaoPostagem='$descricao', imgPostagem='$imgPostagem', tituloPostagem='$titulo', dataPostagem='$data' tbPrestadorServico.codPrestadorServico='$codPrestadorServico' where tbPrestadorServico.emailPrestadorServico like '%$_SESSION[email]%'");
$stmt -> execute();
