...
$stmt = $conexao -> prepare ("Delete tbHorario from tbHorario INNER JOIN tbPrestadorServico on tbHorario.codPrestadorServico = tbPrestadorServico.codPrestadorServico
