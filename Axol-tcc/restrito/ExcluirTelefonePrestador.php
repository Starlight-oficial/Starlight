...
include_once('../restrito/decisao-editarTelefonePrestador.php');
global $conexao;
...
$stmt = $conexao -> prepare ("Delete from tbTelefonePrestadorServico INNER JOIN tbPrestadorServico on tbTelefonePrestadorServico.codPrestadorServico = tbPrestadorServico.codPrestadorServico
                              where tbPrestadorServico.emailUsuario like '%$_SESSION[emailUser]%'");
$stmt -> execute();
