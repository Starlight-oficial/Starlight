...
include_once('../restrito/decisao-editarTelefoneUsario.php');
global $conexao;
...
$stmt = $conexao -> prepare ("Delete tbTelefoneUsuario from tbTelefonePrestadorServico INNER JOIN tbUsuario on tbTelefoneUsuario.codUsuario = tbUsuario.codUsuario
