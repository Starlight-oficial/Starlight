    ...
    <main>
        <div class="login-container2" id="login-container2">
            <div class="form-container2">
                <form class="form form-login" name="diaensaio[]" action="EditarEspecialidade.php" enctype="multipart/form-data" method="post">
                    ...
                    <div class="form-input-container">
                    <div class="contaner">
                        <input type="checkbox" class="btn-check" name="espe[]" value=" Felinos" id="especieEspecialidade"  autocomplete="off"/>Felinos<br/>
                        <input type="checkbox" class="btn-check" name="espe[]" value=" Caes" id="especieEspecialidade"  autocomplete="off"/>Cães<br/>
                        <input type="checkbox" class="btn-check" name="espe[]" value=" Aves" id="especieEspecialidade"  autocomplete="off"/>Aves<br/>
                        <input type="checkbox" class="btn-check" name="espe[]" value=" Peixes" id="especieEspecialidade"  autocomplete="off"/>Peixes<br/>
                        <input type="checkbox" class="btn-check" name="espe[]" value=" Roedores" id="especieEspecialidade"  autocomplete="off"/>Roedores<br/>
                        <input type="checkbox" class="btn-check" name="espe[]" value=" Repteis" id="especieEspecialidade"  autocomplete="off"/>Répteis<br/>
                        <input type="checkbox" class="btn-check" name="espe[]" value=" Outros" id="especieEspecialidade"  autocomplete="off"/>Outros<br/>
                    </div>
