...
//$mostraPostagem = $postagem->listarPostagem($linha);
...
<br><br>
<?php /*
    foreach ($mostraPostagem as $listar) {

        $curtida = $listar['curtidaPostagem']; //Variavel qualquer | Nome do atributo do banco
        $descricao = $listar['descricaoPostagem']; 
    ...
    <main>
        <div class="login-container2" id="login-container2">
            ...
            <form class="form form-login" action="Editar-Postagem.php" enctype="multipart/form-data" method="POST">
                    ...
                    <p class="form-text">Editar Postagem!</p>
        ...
        global $conexao;
        $result_msg_cont = "SELECT * FROM tbPostagem inner join tbPrestadorServico on tbPostagem.codPrestadorServico = tbPrestadorServico.codPrestadorServico  WHERE  tbPrestadorServico.emailPrestadorServico like '%$_SESSION[email]%'";
        ...
        ?>
            <div class="form-input-container">
            <input type="hidden" name="id" value="<?php if(isset($row_msg_cont['codPostagem'])){ echo $row_msg_cont['codPostagem']; } ?>">
            
           
            <input class="form-input" type="text" name="descricaoEditar" placeholder="Digite sua especialidade" value="<?php if(isset($row_msg_cont['descricaoPostagem'])){ echo $row_msg_cont['descricaoPostagem']; } ?>">
            <input class="form-input"  type="file" name="imgEditar" value="<?php if(isset($row_msg_cont['imgPostagem'])){ echo $row_msg_cont['imgPostagem']; } ?>" require>  
            <input class="form-input" type="text" name="tituloEditar" placeholder="Digite sua especialidade" value="<?php if(isset($row_msg_cont['tituloPostagem'])){ echo $row_msg_cont['tituloPostagem']; } ?>">
            <input class="form-input" type="text" name="dataEditar" placeholder="Digite sua especialidade" value="<?php if(isset($row_msg_cont['dataPostagem'])){ echo $row_msg_cont['dataPostagem']; } ?>">
...
<br><br></div></div>
            ...
            <!---         
                    <input type="text" class="form-input" value="<?php echo $curtida ?>" name="curtidaEditar" id="curtidaEditar">
                    <input type="text" class="form-input" value="<?php echo $descricao ?>" name="descricaoEditar" id="descricaoEditar">
                    <input type="text" class="form-input" value="<?php echo $cod ?>" name="codEditar" id="codEditar">
</div>
                    <a href="#" class="form-link">Cadastre-se aqui!</a>
                    <button  class="form-button" type="submit" value="<?php echo $linha ?>" name="linha" id="linha">Salvar</button>
                </form>
            </div>
